...
/*
This tests another standard quiz with another mocked quiz and inputs correct and incorrect answers. We should not 
have to restart the socket between tests because once a user goes to the home page, it should automatically reset.
*/
test("textCreateRoom2", async () => {
  window.HTMLElement.prototype.scrollIntoView = function () {};
